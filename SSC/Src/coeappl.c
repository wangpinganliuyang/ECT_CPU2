 ...
 */
OBJCONST UCHAR OBJMEM aName0x1000[] = "D";
 ...
 */
OBJCONST UCHAR OBJMEM aName0x1001[] = "E";
 ...
 */
OBJCONST UCHAR OBJMEM aName0x1008[] = "D";
 ...
 */
OBJCONST UCHAR OBJMEM aName0x1009[] = "H";
 ...
 * \brief 0x1009 (Hardware version) object name
 */
OBJCONST UCHAR OBJMEM aName0x100A[] = "S";
 ...
 */
OBJCONST UCHAR OBJMEM aName0x1018[] = "I\000V\000P\000R\000S\000\377";
 ...
 */
OBJCONST UCHAR OBJMEM aName0x10F1[] = "E\000L\000S\000\377";
 ...
 */
OBJCONST UCHAR OBJMEM aName0x1C00[] = "S";
 ...
 */
OBJCONST UCHAR OBJMEM aName0x1C32[] = "S\000S\000C\000\000S\000M\000C\000\000G\000D\000S\000S\000C\000S\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000S\000\377";
 ...
 */
OBJCONST UCHAR OBJMEM aName0x1C33[] = "S\000S\000C\000\000S\000M\000C\000\000G\000D\000S\000S\000C\000S\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000S\000\377";
...
void COE_Main(void)
{
    ...
    GDC_R* v1 = &CPU1_CPU2;
    GDC_WR* v2 = &CPU2_CPU1;
    //对写参数的标志位的修改,暂定，若测试有问题，在修改
    if(v1->Flags.bits.DownPara == 2)
    {
        v2->Flags.all &= 0xFFE7;
    }
    //对参数读的修改
    ...
    {
        abort = OBJ_Read(u16StoreIndex,u8StoreSubindex,u32StoreDataSize,NULL,pStoreData,bStoreCompleteAccess);
        if(abort != ABORTIDX_WORKING)//0xFF
        {
            switch(u8PendingSdo)
            {
